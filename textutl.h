...
namespace textutl
{
	...
	ZFORCEINLINE void to_lower_eng(std::string &str)
	{
		to_lower_eng(str, 0);
	}
	ZFORCEINLINE void to_lower_rus(std::string &str)
	{
		to_lower_rus(str, 0);
	}
	ZFORCEINLINE void to_bigger_eng(std::string &str)
	{
		to_bigger_eng(str, 0);
	}
	ZFORCEINLINE void to_bigger_rus(std::string &str)
	{
		to_bigger_rus(str, 0);
	}
	...
	ZFORCEINLINE bool is_numeric(char c);
