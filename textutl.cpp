...
static const char *s_rus_low = "абвгдеЄжзийклмнопрстуфхцчшщъыьэю€";
static const char *s_rus_big = "јЅ¬√ƒ≈®∆«»… ЋћЌќѕ–—“”‘’÷„ЎўЏџ№Ёёя";
...
static bool g_IsLetterRus[256];	//€вл€етс€ ли буквой
static bool g_IsLetterEng[256];	//€вл€етс€ ли буквой


//класс-пустышка дл€ инициализации массивов g_EngCharLow и прочих
//------------------------------------------------------------------------------------------
class dummy
{
public:
...
void textutl::to_translit(const std::string &str, std::string &ret)
{
	...
	{
		char c0 = str[i];
		//провер€ем, вдруг цифра или англ. буква, тогда добавл€ем как есть
